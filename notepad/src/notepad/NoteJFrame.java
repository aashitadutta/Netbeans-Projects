...
public class NoteJFrame extends javax.swing.JFrame {
    ...
    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
        ...
        JMenuItem jMenuItem6 = new JMenuItem(new DefaultEditorKit.CutAction());
    ...
    private void jMenuItem8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem8ActionPerformed
      JMenuItem jMenuItem8 = new JMenuItem(new DefaultEditorKit.PasteAction());
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        int retval = db.showOpenDialog(this);
        ...
        /*catch (java.io.IOException e){
               JOptionPane.showMessageDialog(NoteJFrame.this, file_name); 
            }*/
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
       FileFilter f = new FileNameExtensionFilter("Text Files","txt");
        db.addChoosableFileFilter(f);
         int retval = db.showSaveDialog(this);
         if (retval == javax.swing.JFileChooser.APPROVE_OPTION){
             java.io.File save_file = db.getSelectedFile();
             String file_name = save_file.toString();
             try{
                 FileWriter data = new FileWriter(file_name, false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NoteJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NoteJFrame().setVisible(true);
            }
        });
    }
